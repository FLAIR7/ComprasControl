				...
				<div>
					<div>
						...
						<div class="info">
							...
							data-id="${user.userId}">Edit</button>
							
							<button type="button" class="btn btn-success"
							data-toggle="modal" data-target="#exampleModalPassword"
							data-id="${user.userId}">Change Password</button>
						</div>
					</div>
				</div>
			</div>
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        ...
		        <div class="form-group">
		        	<label for="price" class="control-label">Username</label>
		        	<input type="text" class="form-control" value="${user.username}" id="username">
		        </div>
		      </div>
		      <div class="modal-footer">
		      	 <input name="id" type="hidden" class="form-control" id="id" value="${user.userId}">
		        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
		        <button type="button" class="btn btn-primary" onclick="editUser()" id="salvar">Save</button>
		      </div>
		    </div>
		  </div>
		</div>
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        <div class="form-group">
		        	...
		        	<input type="text" class="form-control" value="${user.password}" id="password1">
		        </div>
		        <div class="form-group">
		        	<label for="price" class="control-label">Repeat Password</label>
		        	<input type="text" class="form-control" value="${user.password}" id="password2">
		        </div>
		      </div>
		      <div class="modal-footer">
		      	 <input name="id" type="hidden" class="form-control" id="idpassword" value="${user.userId}">
		         <input name="id" type="hidden" class="form-control" id="old" value="${user.password}">
		        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
		        <button type="button" class="btn btn-primary" onclick="editPassword()" id="salvar">Save</button>
		      </div>
		    </div>
		  </div>
		</div>
